...
CREATE TABLE IF NOT EXISTS "public"."unit_photos" (
    ...
    "metadata" "jsonb" DEFAULT '{}'::"jsonb",
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    "role" "public"."photo_role" DEFAULT 'gallery'::"public"."photo_role" NOT NULL
);
...
CREATE TABLE IF NOT EXISTS "public"."gallery_photos" (
    ...
    "alt_text" "text",
    "caption" "text",
    "size" "text" DEFAULT 'normal'::"text" NOT NULL,
    "sort_order" integer DEFAULT 0,
    "metadata" "jsonb" DEFAULT '{}'::"jsonb",
    "created_at" timestamp with time zone DEFAULT "timezone"('utc'::"text", "now"()) NOT NULL,
    CONSTRAINT "gallery_photos_size_check" CHECK (("size" = ANY (ARRAY['normal'::"text", 'tall'::"text", 'wide'::"text"])))
);
...
CREATE INDEX "project_photos_project_idx" ON "public"."project_photos" USING "btree" ("project_id");

CREATE INDEX "project_photos_role_idx" ON "public"."project_photos" USING "btree" ("role");



CREATE INDEX "gallery_photos_sort_idx" ON "public"."gallery_photos" USING "btree" ("sort_order");
...
CREATE POLICY "project_photos_public_read" ON "public"."project_photos" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."projects" "p"
  WHERE (("p"."id" = "project_photos"."project_id") AND "p"."is_public"))));
...
CREATE POLICY "project_photos_service_role_full" ON "public"."project_photos" USING (("auth"."role"() = 'service_role'::"text")) WITH CHECK (("auth"."role"() = 'service_role'::"text"));

CREATE POLICY "gallery_photos_service_role_full" ON "public"."gallery_photos" USING (("auth"."role"() = 'service_role'::"text")) WITH CHECK (("auth"."role"() = 'service_role'::"text"));
